  ...
  return (
    ...
    <div className="row align-items-center mt-2">
      ...
      <div className="col-lg-6 text-end"> 
        <span className="me-2 text-primary"><i className="fa-solid fa-chevron-left"></i></span>   
        <span className="me-2 text-primary"><i className="fa-solid fa-chevron-right"></i></span>
